...
##
#H @(#)$Id: construct.gd, v 0.7.8 2010/06/03 21:29:50 gap Exp $
##
...
##
Revision.("/Users/roeder/gap/polymaking/polymaking/lib/construct_gd"):=
	"@(#)$Id: construct.gd, v 0.7.8 2010/06/03   21:29:50  gap Exp $";
