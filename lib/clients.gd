...
##
#H @(#)$Id: clients.gd, v 0.7.8 2010/06/03 21:29:50 gap Exp $
##
...
##
Revision.("/Users/roeder/gap/polymaking/polymaking/lib/clients_gd"):=
	"@(#)$Id: clients.gd, v 0.7.8 2010/06/03   21:29:50  gap Exp $";
#############################################################################
##
